...
public class ExcluirFeedService extends Service {
	...
	//É INTERESSANTE NÃO 
	public ExcluirFeedService() {
		super();
		this.context = this;
		//this.id = new Random().nextInt(999);//colocar parametero
		Log.w("MY-SERVICES", "new ExcluirFeedService");		
	}
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		Log.w("MY-SERVICES", "Excluir Feed Service Start");
		...
		task = new ExcluirFeedTask(context, this, intent, feedAux);
